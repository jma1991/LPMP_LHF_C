...
```{r}
deployApp(appDir = "shiny/v1", appName = "LPMP_LHF_C", appTitle = "LPMP_LHF_C", launch.browser = FALSE, forceUpdate = TRUE)
```

Allocate more memory to the iSEE application:

```{r}
configureApp(appName = "LPMP_LHF_C", appDir = "shiny/v1", size = "xlarge")
```
...
```{r}
deployApp(appDir = "shiny/v2", appName = "LPMP_LHF_C_ATLAS", appTitle = "LPMP_LHF_C_ATLAS", launch.browser = FALSE, forceUpdate = TRUE)
```

Allocate more memory to the iSEE application:

```{r}
configureApp(appName = "LPMP_LHF_C_ATLAS", appDir = "shiny/v2", size = "xlarge")
```
