...
for (n in names(sig)) {
  ...
  plotHeatmap(sce, colour_columns_by = "cluster", order_columns_by = "cluster", features = ids, center = TRUE, symmetric = TRUE, cluster_rows = ifelse(length(ids) >= 2, TRUE, FALSE), show_colnames = FALSE)
